...
How many views, subscribers, and videos does the [Computerphile channel](https://www.youtube.com/user/Computerphile) currently have?
```
...
Collect all comments (including replies) for the [video on "The Census" by *Last Week Tonight* with John Oliver](https://www.youtube.com/watch?v=1aheRpmurAo&t=1s). As we want to use the comments for later exercises, please assign the results to an object called `comments_lwt_census`.
```
