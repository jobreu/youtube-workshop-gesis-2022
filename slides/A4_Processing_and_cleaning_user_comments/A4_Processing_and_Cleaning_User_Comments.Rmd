...
# Assigning the column to a an object named TextEmoRep
TextEmoRep <- LinkDel

# Looping over all emojis for all comments in LinkDel
...
# [Exercise](https://jobreu.github.io/youtube-workshop-gesis-2022/exercises/A4_Preprocessing_and_cleaning_data_question.html) time `r ji("weight_lifting_woman")``r ji("muscle")``r ji("running_man")``r ji("biking_man")`

## [Solutions](https://jobreu.github.io/youtube-workshop-gesis-2022/solutions/A4_Preprocessing_and_cleaning_data_solution.html)