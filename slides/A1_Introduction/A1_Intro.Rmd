...
- PhD Student at University of Ulm
...
- Working version of `R` >= 4.0.0 including RTools4 and a recent version of [RStudio](https://rstudio.com/products/rstudio/download/#download)
...
- For an overview, see [Arthurs et al., 2019](https://doi.org/10.1177/1354856517737222); [Baertl, 2018](https://doi.org/10.1177/1354856517736979)
...
"Software" = c("YouTube Data Tools 1.22", "Webometric 4.1", "Tuber 0.9.9", "vosonSML 0.29.13"),
  ...
  "Disadvantages" = c("Lacking flexibility, less information", "Only first 5 follow-up comments, no error feedback, undetectable time-outs", "Only first 5 follow-up comments (bug)", "Lacking flexibility, only comments"),
