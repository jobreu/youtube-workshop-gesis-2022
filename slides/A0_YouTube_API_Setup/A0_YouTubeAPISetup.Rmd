...
- Use the uppermost checkbox to select all scopes. Do that for every page of scopes using the arrow on the bottom right of the table. Afterwards, click on "update"
...
- This should automatically bring you to the "OAuth Consent Screen" tab, where you should click on "Add Test Users"
...
- Click on the "Oauth 2.0 Client ID" name that you specified before
