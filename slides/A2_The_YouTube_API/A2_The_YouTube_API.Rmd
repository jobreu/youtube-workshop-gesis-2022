...
- From the console in Linux or MacOS (saves html to a file) <br>
<br>
...
![plot](Images/YouTube_schematic2_harvesting.png)
...
- We will use the [YouTube API](https://developers.google.com/youtube/v3/docs) in this workshop
...
- Tuber is using OAuth2.0 authentification because it also let's you change your account information from R
...
.center[![plot](Images/API-call-construction.png)]
...
- For this workshop, we will mostly use the [tubeR package](https://cran.r-project.org/web/packages/tuber/tuber.pdf), and briefly mention the [vosonSML package](https://cran.r-project.org/web/packages/vosonSML/index.html)
