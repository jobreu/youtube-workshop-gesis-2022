...
**Document** = collection of text strings (+ metadata about the documents)
...
```{r cloudy-plot, echo = F, dpi=300, out.width="500px", out.height="500px"}
wordcloud(words = TermFreq$feature,
          freq = TermFreq$frequency,
          min.freq = 10,
          max.words = 50,
...
```{r cool-emoji-plot, echo=F, dpi=300, out.width="700px", out.height="500px"}
EmojiFreq %>% 
head(n = 10) %>% 
  ggplot(aes(x = reorder(feature, -frequency), y = frequency)) +
  geom_bar(stat="identity",
